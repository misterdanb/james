...
IOPorts::IOPorts()
	: MemoryBlock(IO_PORTS_BANKS, IO_PORTS_BANK_SIZE),
	  ...
	  _directionKeysSelected(false),
	  _buttonKeysSelected(false),
	  _lcdDisplayEnabled(false),
	  _windowMapDisplaySelect(false),
	  _windowDisplayEnabled(false),
	  _backgroundAndWindowTileDataSelect(false),
	  _backgroundMapDisplaySelect(false),
	  _spriteSize(),
	  _spriteDisplayEnabled(false),
	  _backgroundDisplayEnabled(false),
	  _lcdMode(),
	  _coincidenceFlag(false),
	  _hBlankInterruptEnabled(false),
	  _vBlankInterruptEnabledInLCD(false),
	  _oamInterruptEnabled(false),
	  _coincidenceInterruptEnabled(false),
	  _scrollX(0),
	  _scrollY(0),
	  _lcdY(0),
	  _lcdYCompare(0),
	  ...
	  _timerStopped(0),
	  _monochromePalette(),
	  _monochromeBackgroundPalette(),
	  _monochromeSpritePalettes(),
	  _colorBackgroundPaletteIndexAutoIncrement(0),
	  _colorBackgroundPalettes(),
	  _colorSpritePaletteIndexAutoIncrement(0),
	  _colorSpritePalettes()
{
	for (int i = 0; i < 4; i++)
	{
