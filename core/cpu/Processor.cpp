...
void Processor::ExecuteInstruction()
{
	if (!_state.halted)
	{
		...
		if (_recording)
		{
			...
			oss << "COUNTER=" << ToFixedDec (_counter, 12) << " | "
				<< "OP_CODE=" << ToFixedHex (GetOpCode (InstructionTable::DEFAULT), 2) << " | "
				<< "OP_LOW=" << ToFixedHex (GetOpLow (InstructionTable::DEFAULT), 2) << " | "
				<< "OP_HIGH=" << ToFixedHex (GetOpHigh (InstructionTable::DEFAULT), 2) << " | "
				<< "A=" << ToFixedHex (_state.a, 2) << " | "
				<< "F=" << ToFixedHex (_state.f, 2) << " | "
				<< "B=" << ToFixedHex (_state.b, 2) << " | "
				<< "C=" << ToFixedHex (_state.c, 2) << " | "
				<< "D=" << ToFixedHex (_state.d, 2) << " | "
		...
		switch (GetOpCode (InstructionTable::DEFAULT))
		{
			...
			case 0x01:
				LD_RR_NN (_state.b, _state.c);
				break;

			case 0x02:
				LD_AA_R (_state.b, _state.c, _state.a);
				break;

			case 0x03:
				INC_RR (_state.b, _state.c);
				break;
			...
			case 0x08:
				LD_AA_SP (GetOpHigh (InstructionTable::DEFAULT), GetOpLow (InstructionTable::DEFAULT));
				break;

			case 0x09:
				ADD_RR_RR (_state.h, _state.l, _state.b, _state.c);
				break;

			case 0x0A:
				LD_R_AA (_state.a, _state.b, _state.c);
				break;

			case 0x0B:
				DEC_RR (_state.b, _state.c);
				break;
			...
			case 0x11:
				LD_RR_NN (_state.d, _state.e);
				break;

			case 0x12:
				LD_AA_R (_state.d, _state.e, _state.a);
				break;

			case 0x13:
				INC_RR (_state.d, _state.e);
				break;
			...
			case 0x19:
				ADD_RR_RR (_state.h, _state.l, _state.d, _state.e);
				break;

			case 0x1A:
				LD_R_AA (_state.a, _state.d, _state.e);
				break;

			case 0x1B:
				DEC_RR (_state.d, _state.e);
				break;
			...
			case 0x21:
				LD_RR_NN (_state.h, _state.l);
				break;

			case 0x22:
				LD_AA_R_INC (_state.h, _state.l, _state.a);
				break;

			case 0x23:
				INC_RR (_state.h, _state.l);
				break;
			...
			case 0x29:
				ADD_RR_RR (_state.h, _state.l, _state.h, _state.l);
				break;

			case 0x2A:
				LD_R_AA_INC (_state.a, _state.h, _state.l);
				break;

			case 0x2B:
				DEC_RR (_state.h, _state.l);
				break;
			...
			case 0x32:
				LD_AA_R_DEC (_state.h, _state.l, _state.a);
				break;
			...
			case 0x34:
				INC_AA (_state.h, _state.l);
				break;

			case 0x35:
				DEC_AA (_state.h, _state.l);
				break;

			case 0x36:
				LD_AA_N (_state.h, _state.l);
				break;
			...
			case 0x39:
				ADD_RR_SP (_state.h, _state.l);
				break;

			case 0x3A:
				LD_R_AA_DEC (_state.a, _state.h, _state.l);
				break;
			...
			case 0x40:
				LD_R_R (_state.b, _state.b);
				break;

			case 0x41:
				LD_R_R (_state.b, _state.c);
				break;

			case 0x42:
				LD_R_R (_state.b, _state.d);
				break;

			case 0x43:
				LD_R_R (_state.b, _state.e);
				break;

			case 0x44:
				LD_R_R (_state.b, _state.h);
				break;

			case 0x45:
				LD_R_R (_state.b, _state.l);
				break;

			case 0x46:
				LD_R_AA (_state.b, _state.h, _state.l);
				break;

			case 0x47:
				LD_R_R (_state.b, _state.a);
				break;

			case 0x48:
				LD_R_R (_state.c, _state.b);
				break;

			case 0x49:
				LD_R_R (_state.c, _state.c);
				break;

			case 0x4A:
				LD_R_R (_state.c, _state.d);
				break;

			case 0x4B:
				LD_R_R (_state.c, _state.e);
				break;

			case 0x4C:
				LD_R_R (_state.c, _state.h);
				break;

			case 0x4D:
				LD_R_R (_state.c, _state.l);
				break;

			case 0x4E:
				LD_R_AA (_state.c, _state.h, _state.l);
				break;

			case 0x4F:
				LD_R_R (_state.c, _state.a);
				break;

			case 0x50:
				LD_R_R (_state.d, _state.b);
				break;

			case 0x51:
				LD_R_R (_state.d, _state.c);
				break;

			case 0x52:
				LD_R_R (_state.d, _state.d);
				break;

			case 0x53:
				LD_R_R (_state.d, _state.e);
				break;

			case 0x54:
				LD_R_R (_state.d, _state.h);
				break;

			case 0x55:
				LD_R_R (_state.d, _state.l);
				break;

			case 0x56:
				LD_R_AA (_state.d, _state.h, _state.l);
				break;

			case 0x57:
				LD_R_R (_state.d, _state.a);
				break;

			case 0x58:
				LD_R_R (_state.e, _state.b);
				break;

			case 0x59:
				LD_R_R (_state.e, _state.c);
				break;

			case 0x5A:
				LD_R_R (_state.e, _state.d);
				break;

			case 0x5B:
				LD_R_R (_state.e, _state.e);
				break;

			case 0x5C:
				LD_R_R (_state.e, _state.h);
				break;

			case 0x5D:
				LD_R_R (_state.e, _state.l);
				break;

			case 0x5E:
				LD_R_AA (_state.e, _state.h, _state.l);
				break;

			case 0x5F:
				LD_R_R (_state.e, _state.a);
				break;

			case 0x60:
				LD_R_R (_state.h, _state.b);
				break;

			case 0x61:
				LD_R_R (_state.h, _state.c);
				break;

			case 0x62:
				LD_R_R (_state.h, _state.d);
				break;

			case 0x63:
				LD_R_R (_state.h, _state.e);
				break;

			case 0x64:
				LD_R_R (_state.h, _state.h);
				break;

			case 0x65:
				LD_R_R (_state.h, _state.l);
				break;

			case 0x66:
				LD_R_AA (_state.h, _state.h, _state.l);
				break;

			case 0x67:
				LD_R_R (_state.h, _state.a);
				break;

			case 0x68:
				LD_R_R (_state.l, _state.b);
				break;

			case 0x69:
				LD_R_R (_state.l, _state.c);
				break;

			case 0x6A:
				LD_R_R (_state.l, _state.d);
				break;

			case 0x6B:
				LD_R_R (_state.l, _state.e);
				break;

			case 0x6C:
				LD_R_R (_state.l, _state.h);
				break;

			case 0x6D:
				LD_R_R (_state.l, _state.l);
				break;

			case 0x6E:
				LD_R_AA (_state.l, _state.h, _state.l);
				break;

			case 0x6F:
				LD_R_R (_state.l, _state.a);
				break;

			case 0x70:
				LD_AA_R (_state.h, _state.l, _state.b);
				break;

			case 0x71:
				LD_AA_R (_state.h, _state.l, _state.c);
				break;

			case 0x72:
				LD_AA_R (_state.h, _state.l, _state.d);
				break;

			case 0x73:
				LD_AA_R (_state.h, _state.l, _state.e);
				break;

			case 0x74:
				LD_AA_R (_state.h, _state.l, _state.h);
				break;

			case 0x75:
				LD_AA_R (_state.h, _state.l, _state.l);
				break;
			...
			case 0x77:
				LD_AA_R (_state.h, _state.l, _state.a);
				break;

			case 0x78:
				LD_R_R (_state.a, _state.b);
				break;

			case 0x79:
				LD_R_R (_state.a, _state.c);
				break;

			case 0x7A:
				LD_R_R (_state.a, _state.d);
				break;

			case 0x7B:
				LD_R_R (_state.a, _state.e);
				break;

			case 0x7C:
				LD_R_R (_state.a, _state.h);
				break;

			case 0x7D:
				LD_R_R (_state.a, _state.l);
				break;

			case 0x7E:
				LD_R_AA (_state.a, _state.h, _state.l);
				break;

			case 0x7F:
				LD_R_R (_state.a, _state.a);
				break;

			case 0x80:
				ADD_R_R (_state.a, _state.b);
				break;

			case 0x81:
				ADD_R_R (_state.a, _state.c);
				break;

			case 0x82:
				ADD_R_R (_state.a, _state.d);
				break;

			case 0x83:
				ADD_R_R (_state.a, _state.e);
				break;

			case 0x84:
				ADD_R_R (_state.a, _state.h);
				break;

			case 0x85:
				ADD_R_R (_state.a, _state.l);
				break;

			case 0x86:
				ADD_R_AA (_state.a, _state.h, _state.l);
				break;

			case 0x87:
				ADD_R_R (_state.a, _state.a);
				break;

			case 0x88:
				ADC_R_R (_state.a, _state.b);
				break;

			case 0x89:
				ADC_R_R (_state.a, _state.c);
				break;

			case 0x8A:
				ADC_R_R (_state.a, _state.d);
				break;

			case 0x8B:
				ADC_R_R (_state.a, _state.e);
				break;

			case 0x8C:
				ADC_R_R (_state.a, _state.h);
				break;

			case 0x8D:
				ADC_R_R (_state.a, _state.l);
				break;

			case 0x8E:
				ADC_R_AA (_state.a, _state.h, _state.l);
				break;

			case 0x8F:
				ADC_R_R (_state.a, _state.a);
				break;

			case 0x90:
				SUB_R_R (_state.a, _state.b);
				break;

			case 0x91:
				SUB_R_R (_state.a, _state.c);
				break;

			case 0x92:
				SUB_R_R (_state.a, _state.d);
				break;

			case 0x93:
				SUB_R_R (_state.a, _state.e);
				break;

			case 0x94:
				SUB_R_R (_state.a, _state.h);
				break;

			case 0x95:
				SUB_R_R (_state.a, _state.l);
				break;

			case 0x96:
				SUB_R_AA (_state.a, _state.h, _state.l);
				break;

			case 0x97:
				SUB_R_R (_state.a, _state.a);
				break;

			case 0x98:
				SBC_R_R (_state.a, _state.b);
				break;

			case 0x99:
				SBC_R_R (_state.a, _state.c);
				break;

			case 0x9A:
				SBC_R_R (_state.a, _state.d);
				break;

			case 0x9B:
				SBC_R_R (_state.a, _state.e);
				break;

			case 0x9C:
				SBC_R_R (_state.a, _state.h);
				break;

			case 0x9D:
				SBC_R_R (_state.a, _state.l);
				break;

			case 0x9E:
				SBC_R_AA (_state.a, _state.h, _state.l);
				break;

			case 0x9F:
				SBC_R_R (_state.a, _state.a);
				break;

			case 0xA0:
				AND_R_R (_state.a, _state.b);
				break;

			case 0xA1:
				AND_R_R (_state.a, _state.c);
				break;

			case 0xA2:
				AND_R_R (_state.a, _state.d);
				break;

			case 0xA3:
				AND_R_R (_state.a, _state.e);
				break;

			case 0xA4:
				AND_R_R (_state.a, _state.h);
				break;

			case 0xA5:
				AND_R_R (_state.a, _state.l);
				break;

			case 0xA6:
				AND_R_AA (_state.a, _state.h, _state.l);
				break;

			case 0xA7:
				AND_R_R (_state.a, _state.a);
				break;

			case 0xA8:
				XOR_R_R (_state.a, _state.b);
				break;

			case 0xA9:
				XOR_R_R (_state.a, _state.c);
				break;

			case 0xAA:
				XOR_R_R (_state.a, _state.d);
				break;

			case 0xAB:
				XOR_R_R (_state.a, _state.e);
				break;

			case 0xAC:
				XOR_R_R (_state.a, _state.h);
				break;

			case 0xAD:
				XOR_R_R (_state.a, _state.l);
				break;

			case 0xAE:
				XOR_R_AA (_state.a, _state.h, _state.l);
				break;

			case 0xAF:
				XOR_R_R (_state.a, _state.a);
				break;

			case 0xB0:
				OR_R_R (_state.a, _state.b);
				break;

			case 0xB1:
				OR_R_R (_state.a, _state.c);
				break;

			case 0xB2:
				OR_R_R (_state.a, _state.d);
				break;

			case 0xB3:
				OR_R_R (_state.a, _state.e);
				break;

			case 0xB4:
				OR_R_R (_state.a, _state.h);
				break;

			case 0xB5:
				OR_R_R (_state.a, _state.l);
				break;

			case 0xB6:
				OR_R_AA (_state.a, _state.h, _state.l);
				break;

			case 0xB7:
				OR_R_R (_state.a, _state.a);
				break;

			case 0xB8:
				CP_R_R (_state.a, _state.b);
				break;

			case 0xB9:
				CP_R_R (_state.a, _state.c);
				break;

			case 0xBA:
				CP_R_R (_state.a, _state.d);
				break;

			case 0xBB:
				CP_R_R (_state.a, _state.e);
				break;

			case 0xBC:
				CP_R_R (_state.a, _state.h);
				break;

			case 0xBD:
				CP_R_R (_state.a, _state.l);
				break;

			case 0xBE:
				CP_R_AA (_state.a, _state.h, _state.l);
				break;

			case 0xBF:
				CP_R_R (_state.a, _state.a);
				break;
			...
			case 0xE0:
				LDH_A_R (GetOpLow (InstructionTable::DEFAULT), _state.a);
				break;

			case 0xE1:
				POP_RR (_state.h, _state.l);
				break;

			case 0xE2:
				LD_A_R (_state.c, _state.a);
				break;
			...
			case 0xE9:
				JP_RR (_state.h, _state.l);
				break;

			case 0xEA:
				LD_AA_R (GetOpHigh (InstructionTable::DEFAULT), GetOpLow (InstructionTable::DEFAULT), _state.a);
				break;
			...
			case 0xF0:
				LDH_R_A (_state.a, GetOpLow (InstructionTable::DEFAULT));
				break;
			...
			case 0xFA:
				LD_R_AA (_state.a, GetOpHigh (InstructionTable::DEFAULT), GetOpLow (InstructionTable::DEFAULT));
				break;
...
void Processor::TakeInterrupt (int bitNumber)
{
	...
	// Set the program counter to the address of the vertical blank interrupt routine.
...
// helper methods
void Processor::FetchInstruction (InstructionTable instructionTable)
{
