...
#define LENGTH LookUpTables::INSTRUCTION_LENGTHS[LookUpTables::DEFAULT_TABLE][GET_OP_CODE()]
#define CYCLES LookUpTables::INSTRUCTION_CYCLES[LookUpTables::DEFAULT_TABLE][GET_OP_CODE()]
#define ADDITIONAL_CYCLES LookUpTables::ADDITIONAL_INSTRUCTION_CYCLES[LookUpTables::DEFAULT_TABLE][GET_OP_CODE()]

#define CB_LENGTH LookUpTables::INSTRUCTION_LENGTHS[LookUpTables::CB_TABLE][CB_GET_OP_CODE()]
#define CB_CYCLES LookUpTables::INSTRUCTION_CYCLES[LookUpTables::CB_TABLE][CB_GET_OP_CODE()]
#define CB_ADDITIONAL_CYCLES LookUpTables::ADDITIONAL_INSTRUCTION_CYCLES[LookUpTables::CB_TABLE][CB_GET_OP_CODE()]
